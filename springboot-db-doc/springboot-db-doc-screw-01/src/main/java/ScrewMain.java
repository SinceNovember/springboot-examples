...
public class ScrewMain {
    ...
    private static final String DB_NAME = "db_blog?serverTimezone=GMT";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "Gepoint";

    private static final String FILE_OUTPUT_DIR = "D://yunai/screw_test";
