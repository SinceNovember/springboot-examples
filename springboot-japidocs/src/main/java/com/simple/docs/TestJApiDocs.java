...
public class TestJApiDocs {
    ...
    public static void main(String[] args) {
        ...
        config.setProjectPath("D:/IdeaProjects/springboot-examples/springboot-japidocs"); // 项目所在目录
        config.setDocsPath("D:/Downloads/"); // 生成 HTML 接口文档的目标目录
