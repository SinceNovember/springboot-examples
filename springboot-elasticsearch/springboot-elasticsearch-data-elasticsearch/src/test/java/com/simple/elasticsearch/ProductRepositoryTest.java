...
import com.simple.elasticsearch.repository.ProductRepository;
...
public class ProductRepositoryTest {
    ...
    public void testInsert() {
        ...
        product.setId(101); // 一般 ES 的 ID 编号，使用 DB 数据对应的编号。这里，先写死
        product.setName("我的测试啊");
    ...
    public void testSelectById() {
        Optional<ESProductDO> userDO = productRepository.findById(101);
        System.out.println(userDO.isPresent());
    }

    @Test // 根据 ID 编号数组，查询多条记录
    public void testSelectByIds() {
        Iterable<ESProductDO> users = productRepository.findAllById(Arrays.asList(101));
